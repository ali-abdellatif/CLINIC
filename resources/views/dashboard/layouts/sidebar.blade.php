...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="index.html" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">cazaClinic</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            <a href="{{route('cities.index')}}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-dock-top"></i>
                <div data-i18n="Account Settings">Cities</div>
            </a>
        </li>
        <li class="menu-item">
        ...
        <li class="menu-item">
            <a href="{{route('subServices.index')}}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-lock-open-alt"></i>
                <div data-i18n="Account Settings">Sub Services</div>
            </a>
        </li>
        <li class="menu-item">
            <a href="{{route('facilities.index')}}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-lock-open-alt"></i>
                <div data-i18n="Account Settings">Facilities</div>
            </a>
        </li>
    </ul>
</aside>
