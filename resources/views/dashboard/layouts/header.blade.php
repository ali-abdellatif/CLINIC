...
<!-- Favicon -->
<link rel="icon" type="image/x-icon" href="{{asset('public/dashboard/img/favicon/favicon.ico')}}" />
...
<link rel="stylesheet" href="{{asset('public/dashboard/vendor/libs/apex-charts/apex-charts.css')}}" />
